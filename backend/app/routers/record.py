...
@router.post("/submit")
def submit_result(sport: str, result: GameResult):
    try:
...
@router.get("/history")
def get_record_history(sport: str):
    try:
...
@router.get("/points")
def get_points_record(sport: str):
    try:
...
def reset_points_record(sport: str):
    try:
...
def get_points_record_history(sport: str):
    try:
