            ...
            <div key={label}>
              ...
              <div className="bg-surface-card border border-surface-border rounded-xl overflow-hidden">
                ...
                {catBets.slice(0, 10).map((bet: any, i: number) => {
                  ...
                  return (
                    <div key={i} className="grid grid-cols-8 gap-2 px-4 py-3 border-b border-surface-border hover:bg-surface-hover items-center">
                      ...
                      <span className="text-right text-gray-400 text-sm">{bet.season_avg}</span>
